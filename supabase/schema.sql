...
-- Viaturas Exemplo Esquadra 991 (Frota Nissan Navara 4x4 com KM Reais e Manutenção)
...
('AM-96-11', 'Nissan Navara 4x4', 5, true, 98620, 'DISPONIVEL', false, 'Parque Principal EQ991 (Ota)', 'Chaveiro Principal - Armário A', 39.0940, -8.9670, 'VTR-991-01', true, 110000, '2026-11-15'),
('AM-96-12', 'Nissan Navara 4x4', 5, true, 105888, 'DISPONIVEL', false, 'Parque Principal EQ991 (Ota)', 'Chaveiro Principal - Armário A', 39.0945, -8.9675, 'VTR-991-02', false, 115000, '2026-10-01'),
('AM-96-13', 'Nissan Navara 4x4', 5, true, 102614, 'DISPONIVEL', false, 'Parque Principal EQ991 (Ota)', 'Chaveiro Principal - Armário A', 39.0935, -8.9665, 'VTR-991-03', false, 110000, '2026-12-01');
